...
\usepackage[color={[RGB]{255,191,191}}, text=Confidentiel, scale=3]{draftwatermark} % Ajout filigrane
...
\begin{titlepage}
    \begin{center}
        ...
        \includegraphics[scale=0.49]{Banniere_Meca.png}
